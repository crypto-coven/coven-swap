    ...
    <div className={styles.modal}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.description}>
          <button className={styles.closeModal} onClick={hide}>
            <Image src="/coolicon.png" alt="close" width={12.5} height={12.5} />
          </button>
          <p className={styles.details}>#{witchId}</p>
          <h1 className={styles.witchName}>{name}</h1>
          <p className={styles.header}>archetype</p>
          <p className={styles.details}>{archetype}</p>
          <br />
          ...
          <div className={styles.buttonShadow}>
            <Button className={styles.button} href="/dashboard">
